...
- (NSString *)stringByTrimmingLeadingAndTrailingWhitespace {
    ...
    [leadingWhiteSpaceRegex replaceMatchesInString:tmp options:NSMatchingWithoutAnchoringBounds range:NSRangeFromString([NSString stringWithFormat:@"0,%ld", [[NSNumber numberWithInteger:[tmp length]] unsignedLongValue]]) withTemplate:@""];

    [trailingWhiteSpaceRegex replaceMatchesInString:tmp options:NSMatchingWithoutAnchoringBounds range:NSRangeFromString([NSString stringWithFormat:@"0,%ld", [[NSNumber numberWithInteger:[tmp length]] unsignedLongValue]]) withTemplate:@""];
