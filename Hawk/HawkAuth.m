...
- (instancetype)withPayloadData:(NSData *)data encoding:(NSStringEncoding)encoding {
    self.payload = [[NSString alloc] initWithData:data encoding:encoding];
    return self;
}

- (instancetype)withPayloadData:(NSData *)data {
    return [self withPayloadData:data encoding:NSUTF8StringEncoding];
}
